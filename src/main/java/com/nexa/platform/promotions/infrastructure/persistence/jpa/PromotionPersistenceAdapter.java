...
public class PromotionPersistenceAdapter implements PromotionRepository {
    ...
    @Override
    public List<Promotion> findByTenantIdOrderByIdAsc(Long tenantId) {
        return repository.findByTenantIdOrderByIdAsc(tenantId);
    }

    @Override
    public Optional<Promotion> findByIdAndTenantId(Long id, Long tenantId) {
    ...
    @Override
    public Optional<Promotion> findByTenantIdAndPromoCode(Long tenantId, String promoCode) {
        return repository.findByTenantIdAndPromoCode(tenantId, promoCode);
    }
