...
public interface PromotionCommandService {
    ...
    Promotion create(Long tenantId, UpsertPromotionResource resource);
    Promotion update(Long tenantId, Long id, UpsertPromotionResource resource);
    Promotion changeStatus(Long tenantId, Long id, String status);
    boolean delete(Long tenantId, Long id);
}
