...
public class WarehouseService {
    ...
    public WarehouseService(WarehouseRepositoryPort warehouses, InventoryItemRepositoryPort inventory, InventoryMovementRepositoryPort movements, WarehouseMapper mapper) { this.warehouses = warehouses; this.inventory = inventory; this.movements = movements; this.mapper = mapper; }
