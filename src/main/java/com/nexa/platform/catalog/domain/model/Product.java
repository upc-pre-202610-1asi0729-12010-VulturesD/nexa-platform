...
public class Product extends AuditableEntity {
    ...
    public void reserveStock(int quantity) {
        ...
        if (getReservedStock() + quantity > getAvailableStock()) {
            throw new IllegalStateException("Insufficient catalog stock for " + name + ".");
        }
        this.reservedStock = getReservedStock() + quantity;
    }
