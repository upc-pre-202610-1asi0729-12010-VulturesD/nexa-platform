...
class CatalogSecurityTests {
    ...
    @Test
    void productsRequireWorkspaceAuthenticationLikeAppsWeb() throws Exception {
    ...
    @Test
    void catalogItemsRequireWorkspaceAuthenticationLikeAppsWeb() throws Exception {
        mockMvc.perform(get("/api/v1/catalog-items")).andExpect(status().isForbidden());
    }

    @Test
    void catalogWritesRequireAuthentication() throws Exception {
